...
public class RunningTask extends Task {
	...
	public RunningTask(long taskId, JobType type, String command, String exec, TaskStatus status, String url, boolean remote) {
		super(taskId, type, command, exec, status,url,remote);
	}
