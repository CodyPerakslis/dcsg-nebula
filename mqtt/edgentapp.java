...
public class edgentapp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        edgentapp subscriber = new edgentapp(args[0]);
        subscriber.run();
    }
     ...
     */
    edgentapp(String mqttPropsPath) throws Exception {
    ...
    void run() throws Exception {
    	PrintStream out = new PrintStream(new FileOutputStream("/Users/ayushi/Downloads/Ayuoutput.txt"));
        System.setOut(out);
...
//        TStream<String> strm2= msgs.get(1).filter(tuple -> Integer.parseInt(tuple) < 50 || Integer.parseInt(tuple) > 80);
		...
		TWindow<Double,Integer> window = doubles.last(10, TimeUnit.SECONDS, Functions.unpartitioned());
...
//        nn=nn.filter(tuple -> Integer.parseInt(tuple) < 50 || Integer.parseInt(tuple) > 80);
		...
		readings.sink(tuple -> System.out.println(tuple));
